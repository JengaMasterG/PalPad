...
func (task_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Task", 1, 3152824900934351035)
	model.Property("Id", 6, 1, 2014530056201047503)
	model.PropertyFlags(1)
	model.Property("Text", 9, 2, 7203207987486299815)
	model.Property("DateCreated", 6, 3, 309727373953561903)
	model.Property("DateFinished", 6, 4, 7620710925671148438)
	model.EntityLastPropertyId(4, 7620710925671148438)
}
